  ...
  return (
    <div className="settings-dialog-backdrop fixed inset-0 z-50 flex items-start justify-center bg-neutral-950/35 px-4 py-10" role="dialog" aria-modal="true" aria-labelledby="settings-dialog-title">
      <section className="parchment-dialog settings-dialog-sheet max-h-[calc(100vh-2.5rem)] w-full max-w-2xl overflow-y-auto overscroll-contain rounded-md p-5">
        ...
        <div className="settings-dialog-content pt-4">
          {selectedTool === "gemini" ? (
            <div className="settings-directory-section">
              <label className="settings-row-title text-sm font-semibold text-neutral-800" htmlFor="profiles-root">
                Gemini 账号目录
              </label>
          ...
          <div className="settings-ledger">
            ...
            <div className="settings-row mt-5">
              <div className="settings-row-copy">
                <div className="settings-row-title text-sm font-semibold text-neutral-800">关闭窗口时</div>
              </div>
              <div className="settings-segment mt-2 inline-flex overflow-hidden rounded-md border border-neutral-300 bg-white/70 p-1">
                <button
                  className={`settings-segment-option rounded px-3 py-1.5 text-sm font-semibold transition ${
          ...
          <div className="settings-dialog-footer">
            <div className="settings-dialog-actions mt-4 flex flex-wrap gap-2">
              {selectedTool === "gemini" ? (
